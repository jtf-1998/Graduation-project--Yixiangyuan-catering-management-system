...
@WebServlet(name = "DisheSaleServlet",urlPatterns="/analyze/DisheSaleServlet")
public class DisheSaleServlet extends BaseServlet {
	...
	protected void doLine(HttpServletRequest request, HttpServletResponse response)
		...
		analyzes=pay.ShowBillAllFromBeganToFinish(began_date,finish_date);
	...
	protected void doLine2(HttpServletRequest request, HttpServletResponse response)
		...
		analyzes=pay.ShowBillAllFromBeganToFinish2(began_date,finish_date);
		response.setContentType("text/html; charset=utf-8");
		System.out.println("**************************************");
		JSONArray jsonArray=JSONArray.fromObject(analyzes);
		System.out.println(jsonArray.toString());
