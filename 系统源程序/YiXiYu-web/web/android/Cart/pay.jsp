...
<section class="aui-flexView">
    ...
    <section class="aui-scrollView">
        ...
        <div class="footer">
            <div class="left" style="height: 100%;text-align: center;line-height: 40px"><a href="${pageContext.request.contextPath}/android/CartServlet?action=doShowCart" id="cancel">取消</a></div>
            <div class="right">
                <a id="btnselect" style="background-color:#FF0B0C;" class="xhlbtn  disable" >支付</a>
            </div>
