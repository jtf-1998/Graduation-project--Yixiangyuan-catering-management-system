...
<ul class="formarea">
    ...
    <h1 style="display: none;" id="order_id">${order_id}</h1>
    <h1 style="display: none;" id="customer_phone">${customer.customerPhone}</h1>
    <h1 style="display: none;" id="customer_name">${customer.customerNickname}</h1>
    <li>
        <label class="lit">预订时间</label>
        <input type="datetime-local" id="order_datetime" placeholder="请选择预订时间" class="textbox" />
    </li>
    <li>
    ...
    <li>
        ...
        <input type="number" id="customer_number" placeholder="请输入消费人数" class="textbox" />
    </li>
    <li>
