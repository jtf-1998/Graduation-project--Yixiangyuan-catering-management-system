...
<script type="text/javascript">
    window.onload=function(){
        ...
        creatChart("菜品销售量",dom,date);
        dom = document.getElementById("container2");
        //绘制图表账单数量与日期关系：
        date={
            "action":"doPie2"
        };
        creatChart("菜品销售金额",dom,date);
        // dom=
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 溢香园火锅店消费管理系统 <span class="c-gray en">&gt;</span> 经营分析子系统<span class="c-gray en">&gt;</span>菜品销售统计<span class="c-gray en">&gt;</span>扇形图分析<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
