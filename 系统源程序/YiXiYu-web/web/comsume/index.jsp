    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a
                            data-href="${pageContext.request.contextPath}/comsume/OrderFormServlet?action=doShow" data-title="预订管理" href="javascript:void(0)">预订管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            <dt><i class="Hui-iconfont">&#xe613;</i> 外卖管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a
                            data-href="${pageContext.request.contextPath}/comsume/TakeawyaOrderFormServlet?action=doShow" data-title="外卖管理" href="javascript:void(0)">外卖管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    ...
                    <li><a
                            data-href="${pageContext.request.contextPath}/comsume/OrderBillServlet?action=doShow" data-title="菜单管理"
        ...
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a
                            data-href="${pageContext.request.contextPath}/comsume/PayServlet?action=doShow" data-title="支付管理"
                            href="javascript:void(0)">支付管理</a></li>
                </ul>
            </dd>
        </dl>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="comsume_main.html">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="comsume_main.html"></iframe>
        </div>
    </div>
</section>
