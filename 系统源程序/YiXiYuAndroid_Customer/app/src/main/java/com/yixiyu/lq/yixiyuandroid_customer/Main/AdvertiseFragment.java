...
public class AdvertiseFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
       ...
       View inflate= inflater.inflate(R.layout.fragment_advertise, container, false);
        ImageView iv_advertise=(ImageView) inflate.findViewById(R.id.iv_advertise);
        iv_advertise.setImageResource(ImgRes);
       return inflate;
    }
